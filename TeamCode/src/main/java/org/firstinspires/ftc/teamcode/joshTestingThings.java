...
@Autonomous(name = "Josh testing things", group = "Beep")
public class joshTestingThings extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        gridNavigation.setGridPosition(1, 0.4,0);

        gridNavigation.driveToPosition(4, 0.4, .5);
